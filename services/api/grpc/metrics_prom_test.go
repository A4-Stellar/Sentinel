...
// attempt updates sentinel_grpc_client_requests_total and
// sentinel_grpc_client_request_duration_seconds by method and status code
...
func TestMetricsUnaryInterceptor_RecordsPrometheusMetrics(t *testing.T) {
	const method = "/sentinel.Events/Stream"
