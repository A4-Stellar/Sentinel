...
const file_proto_sentinel_proto_rawDesc = "" +
	"\n" +
	"\x13proto/sentinel.proto\x12\asentinel\"\xc2\x02\n" +
	"\x05Event\x12\x0e\n" +
	...
	"\x06events\x18\x01 \x03(\v2\x0e.sentinel.EventR\x06events\x12\x1f\n" +
	...
	"\x06Events\x12E\n" +
	"\n" +
	"ListEvents\x12\x1a.sentinel.ListEventsRequest\x1a\x1b.sentinel.ListEventsResponse\x124\n" +
	"\bGetEvent\x12\x18.sentinel.GetEventRequest\x1a\x0e.sentinel.Event\x12>\n" +
	"\fStreamEvents\x12\x1c.sentinel.StreamEventsRequest\x1a\x0e.sentinel.Event0\x01B;Z9github.com/Depo-dev/sentinel/services/api/internal/sentinelb\x06proto3"
...
var file_proto_sentinel_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_proto_sentinel_proto_goTypes = []any{
	(*Event)(nil),               // 0: sentinel.Event
	(*ListEventsRequest)(nil),   // 1: sentinel.ListEventsRequest
	(*ListEventsResponse)(nil),  // 2: sentinel.ListEventsResponse
	(*GetEventRequest)(nil),     // 3: sentinel.GetEventRequest
	(*StreamEventsRequest)(nil), // 4: sentinel.StreamEventsRequest
}
var file_proto_sentinel_proto_depIdxs = []int32{
	0, // 0: sentinel.ListEventsResponse.events:type_name -> sentinel.Event
	1, // 1: sentinel.Events.ListEvents:input_type -> sentinel.ListEventsRequest
	3, // 2: sentinel.Events.GetEvent:input_type -> sentinel.GetEventRequest
	4, // 3: sentinel.Events.StreamEvents:input_type -> sentinel.StreamEventsRequest
	2, // 4: sentinel.Events.ListEvents:output_type -> sentinel.ListEventsResponse
	0, // 5: sentinel.Events.GetEvent:output_type -> sentinel.Event
	0, // 6: sentinel.Events.StreamEvents:output_type -> sentinel.Event
